...
const PointerMagnifier: React.FC<MagnifierProps> = ({bgImage, scale, x, y, width, height, ...props}) => {
  ...
  >
    ...
    <Rect x={x} y={y} width={width} height={height} stroke="grey" strokeWidth={5}/>
    <Line x={x + width / 2} y={y + height / 2} points={[-5, 0, 5, 0]} stroke="red"/>
    <Line x={x + width / 2} y={y + height / 2} points={[0, -5, 0, 5]} stroke="red"/>
  </Group>
  )
}
